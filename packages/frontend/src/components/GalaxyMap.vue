...
async function loadAssets() {
  try {
    // 定义所有需要加载的图标
    const assets = [
      { alias: 'galaxy-single-star', src: '/assets/icons/galaxy/single-star.svg' },
      { alias: 'galaxy-binary-star', src: '/assets/icons/galaxy/binary-star.svg' },
      { alias: 'galaxy-triple-star', src: '/assets/icons/galaxy/triple-star.svg' },
